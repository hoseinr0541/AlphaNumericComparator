 ...
 * each characters to decide the sort order. There are 3 possible cases while
 * iterating,
 * 
 * <li>
 * 
 * <li>At any point if the comparison gives the order(either > or <) then the
 * consecutive characters will not be considered.</li>
 * 
 * For ex., this will be the ordered O/P of the given list of Strings.(The bold
 * characters decides its order)
 * <i><b>2</b>b,<b>100</b>b,a<b>1</b>,A<b>2</b>y,a<b>100</b>,</i>
 * 
 * @author kannan_r
 * 
 */
